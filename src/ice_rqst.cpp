...
//IceRqstBase::IceRqstBase(const std::string& rqstid, const std::string& srv_id, const std::string& method, const std::string& rqst, bool async)
//  : rqstid_(rqstid), srv_id_(srv_id), method_(method), rqst_(rqst), is_async_(async) {
//}

//IceRqstBase::IceRqstBase(const std::string& rqstid, const std::string& srv_id, const std::string& method, const std::string& rqst, const AMD_Srv_CallPtr& cb, bool async)
//  : rqstid_(rqstid), srv_id_(srv_id), method_(method), rqst_(rqst), callback_(cb), is_async_(async) {
//}
IceRqstBase::~IceRqstBase() {
}

//bool IceRqstBase::Start() {
//    bool succ = Request();
//    if(succ) {
//        if(is_async_)
